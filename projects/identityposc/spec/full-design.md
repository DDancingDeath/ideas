...
(`repo` + `workflow` scopes). Git identity locally is `Hitesh Kumar <hik@microsoft.com>`.
...
| Default branch        | `main`                                                                                      |
| Initial commit author | `Hitesh Kumar <hik@microsoft.com>` (current local git identity)                             |
